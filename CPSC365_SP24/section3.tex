...
\begin{figure}[H]
    \centering
    \includesvg[width=\textwidth, pretex=\scriptsize]{modifying_reachability.svg}
...
\begin{center}
    \begin{tabular}{C{0.3\textwidth}C{0.3\textwidth}}
        $m = \begin{bmatrix}
            ...
            + & + & + & \cdot 
        \end{bmatrix}$ & 
        \includegraphics[width=0.2\textwidth, valign=m]{maze.png}
    \end{tabular}
\end{center}
